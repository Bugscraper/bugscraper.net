...
const translations = {
    "en": {
        ...
        "desc-short": "Welcome to the Bugscraper. In this solo or co-op roguelike shooter, battle floor after floor of enemies, aim for the top and settle the score with your tyrannical boss.",
    ...
    "fr": {
        ...
        "desc-2": "<b>Bugscraper</b> est un <b>roguelike shooter solo ou coopératif</b>. En voie vers le bureau de votre tyrannique patron, vous ferez face à des vagues d'ennemis à chaque étage. À l'aide d'une multitude d'armes et une grande diversité d'améliorations, éliminez les et visez le sommet !",
        ...
        // This one is only for Steam. It's at the top of the Steam page under the promo banner.
        "desc-short": "Bienvenue dans le Bugscraper. Dans ce roguelike shooter solo ou coopératif, affrontez étage après étage de vagues d'ennemis, visez le sommet et réglez vos comptes avec votre tyrannique boss.",
